...
export const Row = styled.div`
 z-index: ${props => props.z_indexRow};
  display: flex;
  flex-wrap: wrap;
  ...
  @media (max-width: 575.98px) {
    ...
    margin-top: ${props => set_offset(props.mtSmRow)};
  }
  ...
  @media (min-width: 768px) and (max-width: 1199.98px) {
    ...
    margin-left: ${props => set_offset(props.margin_left_lg)};
  }
...
export const Col = styled.div`
  ...
  margin-left: ${props => set_offset(props.ml)};
  ...
  @media (max-width: 575.98px) {
    ...
    padding-left: ${props => props.p_l_sm};
    margin-left: ${props => set_offset(props.plSm)};
     height: ${props => props.heightSm};
      margin-top: ${props => set_offset(props.mtSmCol)};
  }
  @media (min-width: 576px) and (max-width: 767.98px) {
    ...
    padding-left: ${props => set_offset(props.plMd)};
  }
  @media (min-width: 768px) and (max-width: 1199.98px) {
    ...
    margin-left: ${props => set_offset(props.ml_lg)};
